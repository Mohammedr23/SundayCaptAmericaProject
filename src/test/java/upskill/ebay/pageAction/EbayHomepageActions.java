...
////		EbayHomepageLocatorsObj.btnSearch.click(); ("Used Keys.Enter instead of ".click()")
		...
		public void searchBigAndTallTee() {
			EbayHomepageLocatorsObj.txtbxSearch.sendKeys("Big and tall tee");
			EbayHomepageLocatorsObj.btnSearch.click();
		...
		public void mouseHoverOver() throws Exception {
		...
		public void clickSummary() throws Exception {
			EbayHomepageLocatorsObj.linkSummery.isEnabled();
			EbayHomepageLocatorsObj.linkSummery.click();
			Thread.sleep(3000);
		}
		public void synchronization(){
			/*	Selenium Wait : 
					1. Implicit wait(Global), driver level wait.
					2. Explicit wait(Conditional), most popular in selenium, widely used.
